...
class ParserTest {
    ...
    fun testCh() {
        ...
        assertThrows<InternalException> { p1.parse("b") }
        assertThrows<InternalException> { p1.parse("") }

        val p2 = ch('a')
        assertEquals('a', p2.parse("a"))
        assertThrows<InternalException> { p2.parse("b") }
        assertThrows<InternalException> { p2.parse("") }
    }
    ...
    fun testAny() {
        ...
        assertThrows<InternalException> { p.parse("") }
    }
    ...
    fun testRange() {
        ...
        assertThrows<InternalException> { p1.parse("") }
        assertThrows<InternalException> { p1.parse("c") }
        assertThrows<InternalException> { p1.parse("g") }
        ...
        assertThrows<InternalException> { p2.parse("") }
        assertThrows<InternalException> { p2.parse("c") }
        assertThrows<InternalException> { p2.parse("g") }
    }
    ...
    fun testChs() {
        ...
        assertEquals('f', p1.parse("f"))
        assertThrows<InternalException> { p1.parse("") }
        assertThrows<InternalException> { p1.parse("a") }
        ...
        assertThrows<InternalException> { p2.parse("") }
        assertThrows<InternalException> { p2.parse("b") }
        assertThrows<InternalException> { p2.parse("d") }

        val p3 = chs()
        assertThrows<InternalException> { p3.parse("") }
        assertThrows<InternalException> { p3.parse("a") }
    }
    ...
    fun testNot() {
        ...
        assertThrows<InternalException> { p1.parse("a") }
        assertThrows<InternalException> { p1.parse("c") }
        assertThrows<InternalException> { p1.parse("e") }

        val p2 = not('a')
        assertEquals('b', p2.parse("b"))
        assertThrows<InternalException> { p2.parse("") }
        assertThrows<InternalException> { p2.parse("a") }
    ...
    fun testStr() {
        ...
        assertThrows<InternalException> { p1.parse("ab") }
        assertThrows<InternalException> { p1.parse("abcd") }
        assertThrows<InternalException> { p1.parse("def") }
        assertThrows<InternalException> { p1.parse("") }
    }
    ...
    fun testStrs() {
        ...
        assertThrows<InternalException> { p2.parse("abcd") }
        assertThrows<InternalException> { p2.parse("ghi") }
        assertThrows<InternalException> { p2.parse("") }

        val p3 = strs()
        assertThrows<InternalException> { p3.parse("") }
        assertThrows<InternalException> { p3.parse("abc") }
    }
    ...
    fun testAnd() {
        ...
        assertThrows<InternalException> { p1.parse("hellob") }
        assertThrows<InternalException> { p1.parse("hello") }
        assertThrows<InternalException> { p1.parse("") }

        val p2 = str("hello").and(" world")
        assertEquals(Pair("hello", " world"), p2.parse("hello world"))
        assertThrows<InternalException> { p2.parse("hello a") }
        assertThrows<InternalException> { p2.parse("hello ") }
        assertThrows<InternalException> { p2.parse("") }
    }
    ...
    fun testSeq() {
        ...
        assertThrows<InternalException> { p1.parse("abcdef") }
        assertThrows<InternalException> { p1.parse("fghij") }
        assertThrows<InternalException> { p1.parse("hello") }
        assertThrows<InternalException> { p1.parse("abc") }
        assertThrows<InternalException> { p1.parse("") }

        val p2 = seq(str("abc"))
        assertEquals(listOf("abc"), p2.parse("abc"))
        assertThrows<InternalException> { p2.parse("abcd") }
        assertThrows<InternalException> { p2.parse("def") }
        assertThrows<InternalException> { p2.parse("") }
    ...
    fun testOneOf() {
        ...
        assertThrows<InternalException> { p1.parse("d") }
        assertThrows<InternalException> { p1.parse("") }
        ...
        assertThrows<InternalException> { p4.parse("abc") }
        assertThrows<InternalException> { p4.parse("") }
    }
    ...
    fun testRepeat() {
        ...
        assertEquals(listOf('a', 'a'), p1.parse("aa"))
        assertEquals(listOf('a', 'a', 'a'), p1.parse("aaa"))
        assertThrows<InternalException> { p1.parse("aaaa") }
        assertThrows<InternalException> { p1.parse("abcd") }

        val p2 = ch('a').repeat(3)
        assertThrows<InternalException> { p2.parse("") }
        assertThrows<InternalException> { p2.parse("a") }
        assertThrows<InternalException> { p2.parse("aa") }
        assertEquals(listOf('a', 'a', 'a'), p2.parse("aaa"))
        assertThrows<InternalException> { p2.parse("aaaa") }
        assertThrows<InternalException> { p2.parse("abcd") }
    }
    ...
    fun testOptional() {
        ...
        assertThrows<InternalException> { p1.parse("b") }
        assertThrows<InternalException> { p1.parse("z") }
    }
    ...
    fun testFlatMap() {
        ...
        assertThrows<InternalException> { tag.parse("<aaa>bbb</ccc>") }
    }
    ...
    fun testExpect() {
        ...
        assertThrows<InternalException> { p1.parse("xyz") }
    }
    ...
    fun testNot_() {
        ...
        assertThrows<InternalException> { p1.parse("abcde") }
    }
}